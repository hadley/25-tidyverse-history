...
Overall, I really like the name, but there's one downside: it implies that if you're not using the tidyverse you're using the messyverse. I don't like this implication because I don't believe it's true: the tidyverse is just one way to get the job done, and it's not wrong to use other tools.
...
The precursors to the tidyverse were aided by discussions on mailing lists, like r-help. But these mailing lists were of the era where the majority of R user had PhD's in statistics and were infamous for general unkindness to new learners. I started a ggplot2 mailing list in 2008, explicitly to provide a more friendly place to ask questions.

Fortunately, as the R community away from mailing lists toward moved to stackoverflow and twitter, and most lately to bluesky, we have managed to shift the dynamic so that the R community is now one of the most welcoming programming languages for new users. I think a big part of this welcomingness is due to the diversity of R users, which has been tremendously boosted thanks to the efforts of groups like [R-ladies](https://rladies.org), [Minorities in R](https://mircommunity.com), and [rainbowR](https://rainbowr.org).

### Community contributors

The tidyverse wouldn't be a fraction as good as it is today without the many ways that the community has helped make it better. We make a deliberate effort to encourage contributors to the tidyverse, doing our best to recognise contributions, no matter how big or small. We do a regular in-person attempt to support contributors through the tidyverse developer days ([2019](https://www.tidyverse.org/blog/2019/04/tidyverse-dev-day-at-user-2019/), [2020](https://www.tidyverse.org/blog/2020/02/tidy-dev-days-2020/), [2024](https://www.tidyverse.org/blog/2024/04/tdd-2024/)). They're a fun community building activity, designed to help folks to learn how to contribute to the tidyverse. They were disrupted by Covid, but the plan is to run every year after posit::conf.

Most external contributors tend to provide a few small (but meaningful!) contributions. A really limited number of external contributors end up contributing much time and effort over the course of many years. We recognise these contributors by making them package authors. This formally includes them in package metadata (so they are explicitly acknowledged on CRAN, on the package website, and in the package citation) and gives them write access to the GitHub repository. You can learn more about the rights and responsibilities of authors (and other roles) in our [tidyverse governance model](https://github.com/tidyverse/tidyups/blob/main/004-governance.md).
...
It's been a lot of fun to look back at the last ~20 years of tidyverse. I still love R, love programming, and I plan to keep doing this for as long as I'm able. Here's to the next 20 years!
