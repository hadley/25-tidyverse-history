...
This sent us back to the drawing board and eventually we came up with a new approach called embracing. This style introduced just one new operator `{{ }}`, which you use whenever you have an data-variable referenced by an environment-variable:
...
We [launched this in 2019](https://www.tidyverse.org/blog/2019/06/rlang-0-4-0) and it seems to be have successful, as the number of complaints about tidy evaluation has greatly dropped. It's still a hard technique to learn, but that challenge is now directly related to the growth of abstraction needs to
...
The precursors to the tidyverse were greatly aided by discussions on mailing lists, like r-help. But these mailing lists were definitely of the era where the majority of R user had PhD's in statistics and they were infamous for rude

ggplot2 mailing list. Built up a community.
